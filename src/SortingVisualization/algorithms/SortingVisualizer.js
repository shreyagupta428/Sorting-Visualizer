...
function SortingVisualizer() {
  ...
  const mergeSort=() =>{
   ...
   // foranimations(animations);
    for (let i = 0; i < animations.length; i++) {
      const [type,barOneIdx, newHeight] = animations[i];
      ...
      if(type===1)
      {
        const barOneStyle = arrayBars[barOneIdx].style;
          ...
          setTimeout(() => {
            ...
            barOneStyle.backgroundColor = "limegreen";
...
const foranimations =(animations)=>{
  ...
  const arrayBars = document.getElementsByClassName('array-bar');
   for(let i=0;i<animations.length;i++)
   {
      ...
      {   const barOneStyle = arrayBars[barOneIdx].style;
        const barTwoStyle = arrayBars[barTwoIdx].style;
          //revert color of comparison bars
          setTimeout(() => {
      ...
      if(type===2)
      {
        ...
        const barTwoStyle = arrayBars[barTwoIdx].style;
          ...
          setTimeout(() => {
             ...
             // console.log(temp , barTwoStyle.height)
      ...
      const barTwoStyle = arrayBars[barTwoIdx].style;
        ...
        setTimeout(() => {
          ...
          barOneStyle.backgroundColor = "limegreen";
          barTwoStyle.backgroundColor = "limegreen";
      ...
      if(type===7)
      {
        ...
        setTimeout(() => {
          ...
          barOneStyle.backgroundColor = "turqouise";
